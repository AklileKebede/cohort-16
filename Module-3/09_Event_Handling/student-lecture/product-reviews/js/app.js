...
document.addEventListener('DOMContentLoaded', initializePage); //"hi dom, when you are done loading let me know"
...
function initializePage() {
  ...
  descP.addEventListener('click', (ev) => {
    // alert('Hey'); // used it to make sure that the listener is working
    // Show input, hide p
  ...
  document.getElementById('btnSaveReview').addEventListener('click', (ev) => {
    ev.preventDefault(); // every even has a default, this enables it!
    saveReview();
  });
  //document.getElementById('btnSaveReview').addEventListener('click', saveReview()); doesn't work
